...
import caseStudy1Image from "/src/assets/images/ideaflow.webp";
...
export default {
  ...
  computed: {
    caseStudyCount() {
      const caseStudies = en["case-studies-ux"];
  ...
  >
    <div class="row">
      <div class="col-lg-6 col-md-12 mb-2">
        <p class="tagline">
          {{ $t(`case-studies-ux[${number}].tagline`) }}
        </p>
        <h2 class="mb-3">
          {{ $t(`case-studies-ux[${number}].title`) }}
        </h2>
        <p>
          {{ $t(`case-studies-ux[${number}].content`) }}
        </p>
        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
          <RouterLink
            :to="$t(`case-studies-ux[${number}].link`)"
            class="btn btn-secondary secondary-button"
          >
            {{ $t(`case-studies-ux[${number}].button`) }}
          </RouterLink>
        </div>
      </div>
      <div class="col-lg-6 col-md-12 mb-2">
