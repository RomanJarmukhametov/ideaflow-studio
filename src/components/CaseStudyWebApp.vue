...
export default {
  ...
  computed: {
    caseStudyCount() {
      const caseStudies = en["case-studies-webapp"];
  ...
  >
    <div class="row">
      <div class="col-lg-6 col-md-12 mb-2">
        <p class="tagline">
          {{ $t(`case-studies-webapp[${number}].tagline`) }}
        </p>
        <h2 class="mb-3">
          {{ $t(`case-studies-webapp[${number}].title`) }}
        </h2>
        <p>
          {{ $t(`case-studies-webapp[${number}].content`) }}
        </p>
        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
          <RouterLink
            :to="$t(`case-studies-webapp[${number}].link`)"
            class="btn btn-secondary secondary-button"
          >
            {{ $t(`case-studies-webapp[${number}].button`) }}
          </RouterLink>
        </div>
      </div>
      <div class="col-lg-6 col-md-12 mb-2">
        <div class="row">
          <div class="col">
            <img
              :src="$t(`case-studies-webapp[${number}].image`)"
